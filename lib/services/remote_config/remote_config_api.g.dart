...
class RemoteConfigHostApi {
  ...
  RemoteConfigHostApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<void> setBoolFlags(Map<String, bool> flags) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.snabbit_runner.RemoteConfigHostApi.setBoolFlags$pigeonVar_messageChannelSuffix';
  ...
  Future<void> setStringFlags(Map<String, String> flags) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.snabbit_runner.RemoteConfigHostApi.setStringFlags$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
