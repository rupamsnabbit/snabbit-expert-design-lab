...
class EarningsSummaryView extends StatefulWidget {
  const EarningsSummaryView({super.key});

  @override
  State<EarningsSummaryView> createState() => _EarningsSummaryViewState();
}

class _EarningsSummaryViewState extends State<EarningsSummaryView>
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        if (payoutProvider.earnings?.earningDetails?.summaryItems != null)
          AnimatedSize(
              ...
              child: isExpanded
                  ? Column(
                      children: payoutProvider
                              .earnings?.earningDetails?.summaryItems
                              ?.map((e) {
                            return Padding(
