...
class FamilyDetailsIfDivorced extends StatefulWidget {
  static const String routeName = "/family_details_divorced";

  const FamilyDetailsIfDivorced({super.key});

  @override
  State<FamilyDetailsIfDivorced> createState() =>
      _FamilyDetailsIfDivorcedState();
}

class _FamilyDetailsIfDivorcedState extends State<FamilyDetailsIfDivorced> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OnboardingQuestion(
                      mandatory: true,
                      questionKey: 'years_since_divorce',
                      questionDefault:
                          'How many years since you got a divorce?',
                      criticalError: userProfile.otherDetails?.yearsDivorced
                          ?.isValueAcceptable() ==
                          true
                          ? null
                          : languageProvider.getMessage('pls_review_answer_carefully', "Please review this answer carefully",),
                      answer: Row(
                        children: yearsSinceDivorce.map((years) {
                          return Flexible(
                            flex: 1,
                            child: Padding(
                              padding:
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  userProfile.otherDetails!.yearsDivorced?.value =
                                      years;
                                  userProfileProvider.notifyUserListeners();
                                },
                                child: Container(
  ...
  bool continueCondtions() {
    if (userProfile.otherDetails?.yearsDivorced?.value != null &&
