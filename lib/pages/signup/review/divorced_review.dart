...
class DivorcedReview extends StatefulWidget {
  const DivorcedReview({super.key});

  @override
  State<DivorcedReview> createState() => _DivorcedReviewState();
}

class _DivorcedReviewState extends State<DivorcedReview> {
  bool init = true;
    ...
    return Column(
      ...
      children: [
        ...
        OnboardingQuestion(
          ...
          questionDefault: 'How many years since you got a divorce?',
          answer: ReviewAnswer(
            data: "${userProfile?.otherDetails?.yearsDivorced?.value}",
          ),
        ),
        SizedBox(height: 16.h),
