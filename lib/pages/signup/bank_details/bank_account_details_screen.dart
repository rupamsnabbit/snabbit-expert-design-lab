...
class BankAccountDetailsScreen extends StatefulWidget {
  static const String routeName = "/bank_account_details";
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    languageProvider.getMessage('confirm_bank_account_message',
                        "Are you sure this is your bank account?"),
                  ...
                  BankDetailsQnaReview(
                    ...
                    answer: onboardingProvider.bankVerificationResponse
                  ...
                  BankDetailsQnaReview(
                    ...
                    answer: onboardingProvider
                            .bankVerificationResponse?.accountNumber ??
                        "N/A",
                  ),
                  SizedBox(height: 24.h),
                  BankDetailsQnaReview(
                    question:
                        languageProvider.getMessage("ifsc_code", "IFSC Code"),
                    answer:
                        onboardingProvider.bankVerificationResponse?.ifscCode ??
                            "N/A",
                  ),
                  SizedBox(height: 24.h),
